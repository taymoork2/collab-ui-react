...
while [ "$i" -lt 3 ]; do
  ...
  i=$((i+1))
  bin/sc \
    -D atlas-a.wbx2.com,atlas-integration.wbx2.com,identity.webex.com,idbroker.webex.com,cmi.sc-tx2.huron-dev.com,cmi.hptx1.huron-dev.com,hermes.sc-tx2.huron-dev.com,hermes.hptx1.huron-dev.com,locus-a.wbx2.com,metrics-a.wbx2.com \
    -vv \
    -l sauce_connect.log \
    --pidfile $PID_FILE \
