  ...
  var config = {
    ...
    vendorFiles: {
      ...
      js: [
        ...
        vendor + '/amcharts/dist/amcharts/plugins/export/export.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/FileSaver.js/FileSaver.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/blob.js/blob.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/fabric.js/fabric.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/jszip/jszip.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/pdfmake/pdfmake.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/pdfmake/vfs_fonts.js',
        vendor + '/amcharts/dist/amcharts/plugins/export/libs/xlsx/xlsx.js',
      ...
      css: [
        ...
        vendor + '/amcharts/dist/amcharts/plugins/export/export.css',
      ],
      fonts: [
