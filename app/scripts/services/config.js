...
angular.module('wx2AdminWebClientApp')
  .factory('Config', function() {
    return {
      ...
      adminServiceUrl: 'https://atlas-a.wbx2.com/admin/api/v1/',
