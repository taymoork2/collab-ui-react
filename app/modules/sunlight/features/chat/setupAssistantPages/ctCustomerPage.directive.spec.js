...
describe('Customer Screen Directive', function () {
  ...
  function compileView() {
    var template = '<div id="dummyRootDiv"><div id="dummyPrevSel" class="active"></div>' + '<div id="dummyContainerDiv" selectable class="ct-selectable-container"></div>' + '<div id="dummyElementDiv" selectable><div id="dummySelectableChild" ' + 'class="ct-selectable-element"></div>' + '<div id="dummyChild"></div></div></div>';
