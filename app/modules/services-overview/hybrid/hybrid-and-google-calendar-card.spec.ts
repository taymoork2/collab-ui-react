import { ServicesOverviewHybridAndGoogleCalendarCard } from './hybrid-and-google-calendar-card';

describe('ServicesOverviewHybridCallCard', () => {

  let $state, $q, $modal, $rootScope, Authinfo, CloudConnectorService, Notification;
  ...
  function dependencies(_$state_, _$q_, _$modal_, _$rootScope_, _Authinfo_, _CloudConnectorService_, _Notification_) {
    $state = _$state_;
    $q = _$q_;
    $modal = _$modal_;
  ...
  it('should have sane defaults', () => {
    card = new ServicesOverviewHybridAndGoogleCalendarCard($state, $q, $modal, Authinfo, CloudConnectorService, Notification);
