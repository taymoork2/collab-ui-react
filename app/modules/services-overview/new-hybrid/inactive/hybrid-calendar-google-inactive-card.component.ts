  ...
  public template = `
    <article>
      <div class="inactive-card_header card_header--stretched">
        ...
        <div class="inactive-card_logo"><img src="/images/hybrid-services/Google_Calendar_logo_small.png" alt="{{::servicesOverview.cards.hybridCalendar.googleTitle | translate}}"></div>
      </div>
