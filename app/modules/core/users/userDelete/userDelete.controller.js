(function () {
  ...
  /* @ngInject */
  function UserDeleteCtrl($scope, $rootScope, $stateParams, $q, $timeout, Userservice, Notification, Config, $translate, HuronUser, SunlightConfigService) {
    var vm = this;
    ...
    function deleteUser() {
      ...
      SunlightConfigService.deleteUserConfig.then(function () {
      });
