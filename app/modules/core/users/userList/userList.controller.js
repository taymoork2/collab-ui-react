(function () {
  ...
  /* @ngInject */
  function UserListCtrl($dialogs, $location, $q, $rootScope, $scope, $state, $stateParams, $templateCache, $timeout, $translate, Authinfo, Config, FeatureToggleService, HuronUser, Log, LogMetricsService, Notification, Orgservice, Storage, Userservice, UserListService, Utils) {
