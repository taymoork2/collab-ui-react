(function () {
  ...
  /* @ngInject */
  function PartnerHomeCtrl($templateCache, $scope, $rootScope, $stateParams, $log, $timeout, $dialogs, $translate, $filter, $state, $window, Config, PartnerService, Orgservice, Notification, ReportsService, Log, Auth, Authinfo, ExternalNumberPool, LogMetricsService, TrialService) {
    $scope.load = true;
