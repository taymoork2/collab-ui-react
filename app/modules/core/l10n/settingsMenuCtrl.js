/* @ngInject */
function SettingsMenuCtrl($location, $rootScope, $state, $stateParams, $translate,
  languages, LocalStorage, SessionStorage, StorageKeys) {
  var vm = this;
...
module.exports = SettingsMenuCtrl;
