(function () {
  ...
  /* @ngInject */
  function CustomerAdministratorDetail($interval, $q, $scope, $state, $stateParams, $translate, DialPlanService, ExternalNumberService, ModalService, Notification, PstnSetupService, TelephoneNumberService) {
    var vm = this;
