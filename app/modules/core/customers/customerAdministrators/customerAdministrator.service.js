(function () {
  ...
  angular.module('Core')
    .factory('CustomerAdministratorService', CustomerAdministratorService);

  /* @ngInject */
  function CustomerAdministratorService($q, $translate, ExternalNumberPool, NumberSearchServiceV2, PstnSetupService, TelephoneNumberService, Notification) {
    var service = {
