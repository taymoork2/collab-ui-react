(function () {
  ...
  fdescribe('Controller: enterEmailAddrController', function () {
    ...
    describe('getUserFromEmail', function(){
      ...
      it('should redirect to create-account on success with improper data', function(done){
        DigitalRiverService.getUserFromEmail.and.returnValue($q.when({data:{success:true}}));
        controller.handleEnterEmailAddr().then(function(){
      ...
      it('should redirect to dr-login-forward on success with proper data', function(done){
        DigitalRiverService.getUserFromEmail.and.returnValue($q.when({data:{data:{exists:true},success:true}}));
        controller.handleEnterEmailAddr().then(function(){
