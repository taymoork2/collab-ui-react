(function () {
  ...
  var serviceUrlMapping = {
    ...
    HerculesUrlV2: {
      ...
      cfe: 'https://hercules-loada.ciscospark.com/hercules/api/v2',
      integration: 'https://hercules-a.ciscospark.com/hercules/api/v2',
      prod: 'https://hercules-a.wbx2.com/hercules/api/v2',
    },
    FlagServiceUrl: {
      dev: 'https://hercules-a.ciscospark.com/fls/api/v1',
      cfe: 'https://hercules-loada.ciscospark.com/fls/api/v1',
      integration: 'https://hercules-a.ciscospark.com/fls/api/v1',
