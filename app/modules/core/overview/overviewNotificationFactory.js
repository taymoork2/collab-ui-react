(function () {
  ...
  /* @ngInject */
  function OverviewNotificationFactory(OverviewSetupNotification, OverviewCalendarNotification, OverviewCallConnectNotification, OverviewCallAwareNotification, OverviewCloudSipUriNotification, OverviewDevicesNotification) {
    return {
