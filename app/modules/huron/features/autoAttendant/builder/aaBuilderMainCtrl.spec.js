...
describe('Controller: AABuilderMainCtrl', function () {
  ...
  beforeEach(inject(function (_$state_, _$rootScope_, _$q_, _$compile_, _$stateParams_, _$controller_, _AACommonService_, _AANotificationService_, _AutoAttendantCeInfoModelService_, _AutoAttendantCeMenuModelService_, _AutoAttendantLocationService_, _AAUiModelService_, _AAModelService_, _AANumberAssignmentService_, _AutoAttendantCeService_, _AAValidationService_, _Authinfo_, _HuronConfig_, _$httpBackend_, _AAUiScheduleService_, _AACalendarService_, _AATrackChangeService_, _AADependencyService_, _FeatureToggleService_, _ServiceSetup_, _$modalStack_) {
    $state = _$state_;
