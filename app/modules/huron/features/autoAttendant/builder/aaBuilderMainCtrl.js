(function () {
  ...
  function AABuilderMainCtrl($scope, $translate, $state, $stateParams, $q, AAUiModelService,
    ...
    AATrackChangeService, AADependencyService, ServiceSetup, AAMetricNameService, Analytics) {
      ...
      vm.sendMetricsOnLoad = sendMetricsOnLoad;
      ...
      function setLoadingDone() {
        vm.loading = false;
        sendMetricsOnLoad('load');
      }

      //send the metrics once the page completes loading
      function sendMetricsOnLoad(metric) {
