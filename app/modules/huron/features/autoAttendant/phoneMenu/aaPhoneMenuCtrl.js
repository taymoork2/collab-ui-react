(function () {
  ...
  /* @ngInject */
  function AAPhoneMenuCtrl($scope, $translate, AAUiModelService, AutoAttendantCeMenuModelService, AutoAttendantHybridCareService, AACommonService, QueueHelperService) {
    var vm = this;
