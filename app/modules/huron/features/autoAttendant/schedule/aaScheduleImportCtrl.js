(function () {
  ...
  /* @ngInject */
  function AAScheduleImportCtrl($modalInstance, AutoAttendantCeInfoModelService, AutoAttendantCeService, AACalendarService, AAICalService) {
    ...
    AutoAttendantCeInfoModelService.getCeInfosList().then(function (data) {
      data.aaRecords.forEach(function (value) {
          var obj = {};
