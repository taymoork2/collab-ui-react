import { HuntMethod } from 'modules/huron/features/huntGroup/services';
...
export class HuntGroupMethodComponent implements ng.IComponentOptions {
  ...
  public templateUrl = 'modules/huron/features/huntGroup/huntGroupMethod/huntGroupMethod.html';
  public bindings = {
    huntMethod: '<',
    isNew: '<',
    onChangeFn: '&',
