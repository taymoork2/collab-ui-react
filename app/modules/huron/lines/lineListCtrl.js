(function () {
  ...
  angular
    .module('Huron')
    .controller('LinesListCtrl', ['$scope', '$timeout', '$translate', 'LineListService', 'Log', 'Config', 'Notification',
      function ($scope, $timeout, $translate, LineListService, Log, Config, Notification) {
