(function () {
  ...
  angular
    ...
    .controller('AutoAttendantMainCtrl', AutoAttendantMainCtrl);

  /* @ngInject */
  function AutoAttendantMainCtrl($scope, $translate, $stateParams, AAModelService, AutoAttendantCeInfoModelService, AutoAttendantCeService, Notification) {
    var vm = this;
    vm.aaModel = {};
    vm.navTabs = [{
      title: "autoAttendant.general",
      state: "autoattendant.main.general"
    }, {
      title: "autoAttendant.autoAttendant",
