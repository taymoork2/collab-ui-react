(function () {
  ...
  function FusionUtils($translate) {
    ...
    var orderedServices = ['squared-fusion-mgmt', 'squared-fusion-cal', 'squared-fusion-gcal', 'squared-fusion-uc', 'squared-fusion-ec', 'squared-fusion-media', 'spark-hybrid-datasecurity', 'squared-fusion-khaos'];
