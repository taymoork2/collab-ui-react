(function () {
  ...
  /* @ngInject */
  function ReassignClusterControllerV2(cluster, connector, MediaClusterServiceV2, MediaServiceActivationV2, $translate, $modalInstance, Notification, HybridServicesClusterService) {
    var vm = this;
