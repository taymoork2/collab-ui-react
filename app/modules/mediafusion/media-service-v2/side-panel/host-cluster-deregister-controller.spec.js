...
describe('Controller: HostClusterDeregisterControllerV2', function () {
  ...
  var vm, controller, $rootScope, cluster, orgName, MediaClusterServiceV2, XhrNotificationService, $q, $translate, modalInstanceMock, windowMock, log, redirectTargetPromise, $modal, httpBackend;
  ...
  it('should open a model when DeRegister is called with mock deleteCluster promise is called', function () {
    ...
    spyOn(MediaClusterServiceV2, 'deleteCluster').and.returnValue(deleteClusterDefered.promise);
