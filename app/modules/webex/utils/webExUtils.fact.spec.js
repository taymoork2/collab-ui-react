...
describe('WebExUtilsFact', function () {
  ...
  it('can check if site iframe supported (release order >= 400)', inject(function (WebExUtilsFact) {
  ...
  it('can check if site is iframe supported (release order = null; enableT30UnifiedAdmin = true', inject(function (WebExUtilsFact) {
    WebExUtilsFact.isSiteSupportsIframe("test.site.com").then(
      function isSiteSupportsIframeSuccess(response) {
        var isIframeSupported = response.isIframeSupported;
        expect(isIframeSupported).toBe(true);
  ...
  it('can check if site is not iframe supported (release order < 400; and enableT30UnifiedAdmin = false', inject(function (WebExUtilsFact) {
    WebExUtilsFact.isSiteSupportsIframe("test.site.com").then(
      function isSiteSupportsIframeSuccess(response) {
        var isIframeSupported = response.isIframeSupported;
  ...
  it('can check if site is not iframe supported (release order < 400; and enableT30UnifiedAdmin = null', inject(function (WebExUtilsFact) {
    WebExUtilsFact.isSiteSupportsIframe("test.site.com").then(
      function isSiteSupportsIframeSuccess(response) {
        var isIframeSupported = response.isIframeSupported;
        expect(isIframeSupported).toBe(false);
  ...
  it('can check if site is not iframe supported (release order = null; and enableT30UnifiedAdmin = null)', inject(function (WebExUtilsFact) {
    WebExUtilsFact.isSiteSupportsIframe("test.site.com").then(
      function isSiteSupportsIframeSuccess(response) {
        var isIframeSupported = response.isIframeSupported;
        expect(isIframeSupported).toBe(false);
