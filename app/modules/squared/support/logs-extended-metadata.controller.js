(function () {
  ...
  angular.module('Squared')
    .controller('LogsExtendedMetadataController', LogsExtendedMetadataController);

  module.exports = LogsExtendedMetadataController;

  /* @ngInject */
  function LogsExtendedMetadataController(title, data, $timeout, $scope, $log, Notification) {
    var vm = this;
    vm.title = title;
    vm.copied = false;
    var copiedTimer;
