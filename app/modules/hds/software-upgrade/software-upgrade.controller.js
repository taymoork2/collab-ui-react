(function () {
  ...
  angular
    .module('HDS')
    .controller('HDSSoftwareUpgradeController', HDSSoftwareUpgradeController);

  /* @ngInject */
  function HDSSoftwareUpgradeController($translate, $modalInstance, servicesId, connectorType, availableVersion, cluster, ClusterService, FusionClusterService, Notification) {
    var vm = this;
    vm.upgrading = false;
