...
describe('Controller: AALandingCtrl', function () {
  var controller, AALandingCtrl, Authinfo, Notification, DirectoryNumberService, AutoAttendantCeService;
  ...
  beforeEach(inject(function (_$rootScope_, _$q_, $controller, _$translate_, _Authinfo_, _Notification_,
    ...
    controller = $controller('AALandingCtrl', {});
    $scope.$apply();
  }));
