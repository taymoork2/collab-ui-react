...
var CareLandingPage = function () {
  ...
  this.foundCardName = element(by.css('.cs-card-container .cs-card-layout .cs-card--medium header p'));
  this.deleteCardBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .cs-card--medium .right .close'));
  this.editCardBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .cs-card--medium article'));
