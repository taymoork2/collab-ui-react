...
var CareLandingPage = function () {
  ...
  this.foundCardName = element(by.css('.cs-card-container .cs-card-layout .cs-card--small header p'));
  this.deleteCardBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .cs-card--small .right .close'));
  this.editCardBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .cs-card--small article'));
