...
var CareSettingsPage = function () {
  this.pickRouting = element.all(by.model('localCareSettings.orgChatConfig.selectedRouting')).first();
  this.pushRouting = element.all(by.model('localCareSettings.orgChatConfig.selectedRouting')).last();
