...
var ChatTemplateCreation = function () {
  ...
  this.botPreviewIcon = element(by.css('.img  .icon-bot-four'));
  ...
  this.chatTemplateName = element(by.css('.cs-card-container .cs-card-layout .cs-card--small header p'));
  this.downloadEmbedCodeOnCard = element(by.css('.cs-card-container .cs-card-layout .cs-card--small footer .icon-download'));
