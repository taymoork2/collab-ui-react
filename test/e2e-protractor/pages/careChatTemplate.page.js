...
var ChatTemplateCreation = function () {
  ...
  this.deleteEmbedCodeBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .small .right .close'));
  this.editChatTemplateBtnOnCard = element(by.css('.cs-card-container .cs-card-layout .small article'));
