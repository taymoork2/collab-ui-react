...
var AutoAttendantPage = function () {
  ...
  this.initialMessage = element(by.css('aa-message-type [name="messageInput"]'));
  this.initialMessageOptions = element(by.css('select[name="messageSelect"] + div a.select-toggle'));
  this.initialPlayMessageOption = element(by.css('select[name="messageSelect"] + div div.dropdown-menu')).all(by.tagName('li')).first();
  this.initialMediaUploadInput = element(by.name('mediaUploadInput'));
